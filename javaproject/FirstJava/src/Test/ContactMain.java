...
//		Contact 인스턴스 생성 : 생성자를 이용한 데이터 초기화
		Contact c1 = new Contact("박민", "010", "min@naver.com", "서울시", "1991-08-08", "가족");
//
...
//
//		c1.setName("민");
//		c1.setPhoneNumber("017");
//		c1.setEmail("park@naver.com");
//
//		System.out.println();
//		c1.printInfo();
...
//			사용자 요청에 따라 프로그램 종료/진행 => 분기
			...
			String brithDay = in.nextLine();
			
			System.out.println("그룹 >>> ");
			String group = in.nextLine();
			
			Contact c = new Contact(name, phoneNumber, email, address, brithDay, group);
